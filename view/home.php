    ...
    <main class="main-content">
        ...
        <section id="modules" class="modules-section container">
            ...
            <div class="modules-grid">
                ...
                <a href="/view/monitoring.php" class="module-card">
                ...
                <a href="/view/quiz.php" class="module-card">
                ...
                <a href="/view/game.php" class="module-card">
                ...
                <a href="/view/donation.php" class="module-card">
